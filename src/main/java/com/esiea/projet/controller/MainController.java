...
import com.esiea.projet.dataAccessObject.AppUserDao;
import com.esiea.projet.dataAccessObject.CountryDao;
...
import com.esiea.projet.validator.AppUserValidator;
...
public class MainController {
    ...
    public String viewMembers(Model model) {
        ...
        List<UserModel> list = appUserDAO.getAppUsers();
    ...
    public String viewRegister(Model model) {
        ...
        List<CountryModel> countries = countryDAO.getCountries();
