package com.esiea.projet.validator;
...
public class AppUserValidator implements Validator {
    ...
    public void validate(Object target, Errors errors) {
        ...
        if (!this.emailValidator.isValid(appUserForm.getEmail())) {
            ...
            UserModel dbUser = appUserDAO.findAppUserByEmail(appUserForm.getEmail());
            if (dbUser != null) {
        ...
        if (!errors.hasFieldErrors("userName")) {
            UserModel dbUser = appUserDAO.findAppUserByUserName(appUserForm.getUserName());
            if (dbUser != null) {
